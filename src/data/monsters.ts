...
const list: MonsterDef[] = [
  ...
  { id: 'squelette', name: 'Squelette', lore: 'Os blanchis animés par un vieux sortilège, il cliquette dans le noir sans jamais se lasser.', color: 0xe8e8e8, hp: 130, atk: 81, def: 16, xp: 900, level: 25, speed: 50, behavior: 'contact', drops: [goldMid, potion] },
  ...
  // Zone 6 — enfer
  { id: 'diablotin', name: 'Diablotin', lore: 'Farceur des flammes, vif et hargneux, il fonce en ricanant droit sorti des enfers.', color: 0xd84315, hp: 480, atk: 238, def: 35, xp: 4200, level: 46, speed: 150, behavior: 'charge', drops: [goldMid, potion, { kind: 'material', materialId: 'gemme-brute', chance: 0.06, min: 1, max: 1 }] },
  { id: 'gargouille', name: 'Gargouille', lore: 'Statue de pierre qui feint le sommeil, puis s\'éveille d\'un coup pour fondre sur l\'imprudent.', color: 0x546e7a, hp: 620, atk: 250, def: 55, xp: 4800, level: 46, speed: 60, behavior: 'contact', drops: [goldMid, potion, { kind: 'material', materialId: 'minerai-fer', chance: 0.06, min: 1, max: 1 }, { kind: 'item', itemId: 'arc-souple', chance: 0.03, min: 1, max: 1 }] },
  ...
  { id: 'gardien-flamme', name: 'Gardien Flamme', lore: 'Colosse ardent scellé aux portes de l\'enfer, brasier vivant qui calcine quiconque prétend passer.', color: 0xbf360c, hp: 5000, atk: 130, def: 65, xp: 6000, level: 58, speed: 0, behavior: 'contact', drops: [goldMid, potion, { kind: 'material', materialId: 'gemme-brute', chance: 0.25, min: 1, max: 2 }] },
  // Boss — zone 3 (jungle)
  {
  ...
  {
    id: 'roi-liche', name: 'Roi Liche', lore: 'Seigneur mort-vivant au sceptre glacé, il commande aux légions du cimetière depuis son trône d\'os.', color: 0x4527a0, hp: 9000, atk: 130, def: 40, xp: 18000, level: 48, speed: 40, behavior: 'projectile', boss: true,
    drops: [
  ...
  {
    id: 'seigneur-dechu', name: 'Seigneur Déchu', lore: 'Maître ultime des enfers, ange tombé rongé de haine : l\'affronter, c\'est défier l\'apocalypse elle-même.', color: 0x8a1414, hp: 14000, atk: 190, def: 55, xp: 30000, level: 51, speed: 70, behavior: 'charge', boss: true,
    drops: [
