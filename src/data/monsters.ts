...
const list: MonsterDef[] = [
  ...
  M({ id: 'fabre', name: 'Fabre', lore: 'Une chenille pataude et placide qui broute l\'herbe tendre sans jamais presser le pas.', color: 0x8bc34a, xp: 260, level: 4, role: 'normal', speed: 15, behavior: 'contact', drops: [goldSmall, potion, { kind: 'material', materialId: 'herbe-tendre', chance: 0.08, min: 1, max: 1 }] }),
  ...
  M({ id: 'serpent-des-sables', name: 'Serpent des sables', lore: 'Reptile fauve qui ondule sous les dunes, invisible jusqu\'à ce qu\'il jaillisse du sable pour fondre d\'une ruée sur sa proie.', color: 0xd2a679, xp: 700, level: 32, role: 'rapide', speed: 120, behavior: 'charge', drops: [goldMid, potion, { kind: 'material', materialId: 'dard-de-scorpion', chance: 0.05, min: 1, max: 1 }] }),
  ...
  {
    id: 'dragon-flamme', name: 'Dragon de flamme', lore: 'Terreur écailleuse au souffle brûlant : majestueux, féroce, il ne laisse que des cendres.', color: 0xc62828, hp: 1450, atk: 235, def: 52, xp: 9500, level: 66, speed: 60, behavior: 'charge', mvp: true,
    drops: [
  ...
  // ═══ Zone 5 — cimetière ═══
  M({ id: 'goule', name: 'Goule', lore: 'Charognarde des tombes, vorace et griffue, elle traque la chair fraîche au fond du cimetière.', color: 0x556b2f, xp: 3200, level: 53, role: 'costaud', speed: 70, behavior: 'contact', drops: [goldMid, potion, { kind: 'material', materialId: 'gemme-brute', chance: 0.05, min: 1, max: 1 }, { kind: 'item', itemId: 'baton-feuillu', chance: 0.03, min: 1, max: 1 }] }),
  ...
  // ═══ Zone 6 — enfer ═══
  M({ id: 'diablotin', name: 'Diablotin', lore: 'Farceur des flammes, vif et hargneux, il fonce en ricanant droit sorti des enfers.', color: 0xd84315, xp: 4200, level: 62, role: 'rapide', speed: 150, behavior: 'charge', drops: [goldMid, potion, { kind: 'material', materialId: 'gemme-brute', chance: 0.06, min: 1, max: 1 }] }),
  ...
  M({ id: 'diablotin-geant', name: 'Diablotin géant', lore: 'Démon des braises boursouflé de rage, ses cornes raclent la voûte et son rire calcine.', color: 0xd84315, xp: 6200, level: 65, role: 'rapide', speed: 132, behavior: 'charge', size: 'grand', artFrom: 'diablotin', drops: [goldMid, potion, { kind: 'material', materialId: 'gemme-brute', chance: 0.08, min: 1, max: 1 }] }),
  ...
  { id: 'gardien-flamme', name: 'Gardien Flamme', lore: 'Colosse ardent scellé aux portes de l\'enfer, brasier vivant qui calcine quiconque prétend passer.', color: 0xbf360c, hp: 5000, atk: 130, def: 65, xp: 6000, level: 74, speed: 0, behavior: 'contact', drops: [goldMid, potion, { kind: 'material', materialId: 'gemme-brute', chance: 0.25, min: 1, max: 2 }] },
  // Boss — zone 3 (jungle)
  {
  ...
  {
    id: 'seigneur-dechu', name: 'Seigneur Déchu', lore: 'Maître ultime des enfers, ange tombé rongé de haine : il manie les meilleures armes de chaque classe — lame, feu, flèches et néant.', color: 0x8a1414, hp: 16500, atk: 205, def: 60, xp: 30000, level: 74, speed: 90, behavior: 'charge', boss: true, bossClass: 'chevalier', bossSummon: 'diablotin',
    drops: [
  ...
  {
    id: 'boss-crabe', name: 'Roi des Crabes', lore: 'Monarque cuirassé des récifs, blindage insolent et pinces tranchantes : il claque ses tenailles comme des cisailles et bondit de côté pour broyer l\'imprudent.', color: 0xd8431a, hp: 5600, atk: 142, def: 58, xp: 10200, level: 63, speed: 96, behavior: 'charge', boss: true, bossClass: 'swordsman', bossSummon: 'crabe-geant', size: 'grand',
    drops: [
