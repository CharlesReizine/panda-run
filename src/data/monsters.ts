...
const list: MonsterDef[] = [
  ...
  M({ id: 'vautour-geant', name: 'Vautour royal', lore: 'Charognard colossal au bec d\'acier : il éclipse le soleil avant de fondre en piqué.', color: 0x8a6f5c, xp: 2200, level: 56, role: 'rapide', speed: 118, behavior: 'charge', aerial: true, size: 'grand', artFrom: 'vautour', drops: [goldMid, potion] }),
