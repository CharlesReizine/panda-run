...
const list: MonsterDef[] = [
  ...
  M({ id: 'angeling', name: 'Angeling', lore: 'Un ange dodu et candide qui flotte doucement, porte-bonheur ailé au cœur tendre.', color: 0xffffff, xp: 260, level: 5, role: 'frele', speed: 30, behavior: 'contact', floatPx: 10, drops: [goldSmall, potion, { kind: 'material', materialId: 'trefle-chance', chance: 0.03, min: 1, max: 1 }] }),
