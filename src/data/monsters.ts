...
const list: MonsterDef[] = [
  ...
  { id: 'zombie', name: 'Zombie', lore: 'Cadavre ambulant et hagard, il avance en titubant, mû par une faim qui ne meurt jamais.', color: 0x6b8e63, hp: 165, atk: 72, def: 16, xp: 900, level: 21, speed: 22, behavior: 'contact', drops: [goldMid, potion] },
  {
  ...
  { id: 'squelette', name: 'Squelette', lore: 'Os blanchis animés par un vieux sortilège, il cliquette dans le noir sans jamais se lasser.', color: 0xe8e8e8, hp: 130, atk: 81, def: 16, xp: 900, level: 26, speed: 50, behavior: 'contact', drops: [goldMid, potion] },
  ...
  { id: 'gargouille', name: 'Gargouille', lore: 'Statue de pierre qui feint le sommeil, puis s\'éveille d\'un coup pour fondre sur l\'imprudent.', color: 0x546e7a, hp: 620, atk: 250, def: 55, xp: 4800, level: 47, speed: 60, behavior: 'contact', drops: [goldMid, potion, { kind: 'material', materialId: 'minerai-fer', chance: 0.06, min: 1, max: 1 }, { kind: 'item', itemId: 'arc-souple', chance: 0.03, min: 1, max: 1 }] },
