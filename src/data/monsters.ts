...
const list: MonsterDef[] = [
  ...
  M({ id: 'harfang-spectral', name: 'Harfang spectral', lore: 'Chouette fantomatique au plumage blafard, elle plane sans bruit dans la brume du cimetière et fond en silence, plus coriace qu\'elle n\'en a l\'air.', color: 0xe3f2fd, xp: 3100, level: 53, role: 'volant', speed: 85, behavior: 'charge', aerial: true, drops: [goldMid, potion, { kind: 'material', materialId: 'gemme-brute', chance: 0.05, min: 1, max: 1 }] }),
  // ═══ Zone 2 — désert ═══
  M({ id: 'scorpion', name: 'Scorpion', lore: 'Chasseur du sable, patient et venimeux, il détend son dard dès qu\'une ombre s\'approche.', color: 0xd98e32, xp: 650, level: 26, role: 'costaud', speed: 60, behavior: 'contact', drops: [goldMid, potion, { kind: 'material', materialId: 'dard-de-scorpion', chance: 0.05, min: 1, max: 1 }] }),
  M({ id: 'fourmi-geante', name: 'Fourmi géante', lore: 'Insecte des dunes vif et increvable, elle détale en tous sens puis fond droit sur l\'intrus, mandibules ouvertes.', color: 0x8a4b2a, xp: 760, level: 26, role: 'rapide', speed: 135, behavior: 'charge', drops: [goldMid, potion, { kind: 'material', materialId: 'dard-de-scorpion', chance: 0.05, min: 1, max: 1 }] }),
  M({ id: 'scarabee-cornu', name: 'Scarabée cornu', lore: 'Coléoptère cuirassé au front armé d\'une corne : il baisse la tête et charge tout ce qui bouge.', color: 0x5b6b3a, xp: 900, level: 26, role: 'tank', speed: 92, behavior: 'charge', drops: [goldMid, potion, { kind: 'material', materialId: 'minerai-fer', chance: 0.06, min: 1, max: 1 }] }),
  M({ id: 'orc-guerrier', name: 'Orc guerrier', lore: 'Brute belliqueuse qui adore la bagarre : il charge en beuglant, hache au poing.', color: 0x4a7c3f, xp: 1050, level: 26, role: 'costaud', speed: 50, behavior: 'charge', drops: [goldMid, potion, { kind: 'material', materialId: 'minerai-fer', chance: 0.06, min: 1, max: 1 }] }),
  M({ id: 'momie', name: 'Momie', lore: 'Revenante des tombeaux, elle traîne ses bandelettes d\'un pas lent mais implacable.', color: 0xd8cfae, xp: 950, level: 26, role: 'tank', speed: 30, behavior: 'contact', drops: [goldMid, potion, { kind: 'item', itemId: 'plastron-feuilles', chance: 0.05, min: 1, max: 1 }, { kind: 'item', itemId: 'baton-feuillu', chance: 0.05, min: 1, max: 1 }] }),
  M({ id: 'vautour', name: 'Vautour', lore: 'Charognard opportuniste qui tournoie haut avant de fondre en piqué sur les faibles.', color: 0x8a6f5c, xp: 750, level: 26, role: 'rapide', speed: 110, behavior: 'charge', drops: [goldMid, potion, { kind: 'item', itemId: 'arc-souple', chance: 0.05, min: 1, max: 1 }] }),
  M({ id: 'zombie', name: 'Zombie', lore: 'Cadavre ambulant et hagard, il avance en titubant, mû par une faim qui ne meurt jamais.', color: 0x6b8e63, xp: 900, level: 26, role: 'costaud', speed: 22, behavior: 'contact', drops: [goldMid, potion] }),
  M({
    id: 'mini-baphomet', name: 'Mini Baphomet', lore: 'Diablotin cornu au sourire mauvais, minuscule mais déjà rongé par la malice infernale.', color: 0x6a1b4d, xp: 1500, level: 26, role: 'rapide', speed: 80, behavior: 'charge',
  ...
  M({ id: 'serpent-des-sables', name: 'Serpent des sables', lore: 'Reptile fauve qui ondule sous les dunes, invisible jusqu\'à ce qu\'il jaillisse du sable pour fondre d\'une ruée sur sa proie.', color: 0xd2a679, xp: 700, level: 29, role: 'rapide', speed: 120, behavior: 'charge', drops: [goldMid, potion, { kind: 'material', materialId: 'dard-de-scorpion', chance: 0.05, min: 1, max: 1 }] }),
  ...
  M({ id: 'squelette', name: 'Squelette', lore: 'Os blanchis animés par un vieux sortilège, il cliquette dans le noir sans jamais se lasser.', color: 0xe8e8e8, xp: 900, level: 39, role: 'normal', speed: 50, behavior: 'contact', drops: [goldMid, potion] }),
  M({ id: 'chauve-souris', name: 'Chauve-souris', lore: 'Bestiole nerveuse et imprévisible, elle zigzague dans l\'ombre et pique dès qu\'on baisse la garde.', color: 0x6b4f9e, xp: 600, level: 39, role: 'rapide', speed: 120, behavior: 'charge', drops: [goldMid, potion] }),
  M({ id: 'fantome', name: 'Fantôme', lore: 'Âme errante et mélancolique qui hante les cavernes et souffle des projectiles glacés.', color: 0xb2ebf2, xp: 700, level: 39, role: 'distant', speed: 35, behavior: 'projectile', drops: [goldMid, potion, { kind: 'material', materialId: 'gemme-brute', chance: 0.04, min: 1, max: 1 }] }),
  ...
  M({ id: 'crabe-geant', name: 'Crabe géant', lore: 'Sentinelle bardée de carapace sur la plage, lente mais coriace, elle ne cède pas un pouce de sable.', color: 0xe64a19, xp: 1400, level: 56, role: 'tank', speed: 40, behavior: 'contact', aquatic: true, drops: [goldMid, potion, { kind: 'material', materialId: 'gemme-brute', chance: 0.05, min: 1, max: 1 }] }),
  M({ id: 'meduse', name: 'Méduse', lore: 'Beauté translucide et trompeuse, elle dérive au gré des flots et décharge ses filaments urticants.', color: 0xba68c8, xp: 1350, level: 26, role: 'distant', speed: 25, behavior: 'projectile', aquatic: true, drops: [goldMid, potion, { kind: 'material', materialId: 'gemme-brute', chance: 0.05, min: 1, max: 1 }] }),
  ...
  M({ id: 'requin', name: 'Requin', lore: 'Prédateur silencieux des eaux profondes : il glisse dans le bleu puis fond sur le nageur, gueule béante.', color: 0x546e7a, xp: 980, level: 26, role: 'rapide', speed: 130, behavior: 'charge', aquatic: true, drops: [goldMid, potion, { kind: 'material', materialId: 'croc-de-loup', chance: 0.06, min: 1, max: 1 }] }),
  M({ id: 'piranha', name: 'Piranha', lore: 'Nuée de dents miniature : seul il n\'est rien, en banc il déchiquette tout ce qui remue dans l\'eau.', color: 0xc0392b, xp: 520, level: 26, role: 'frele', speed: 100, behavior: 'contact', aquatic: true, tex: 'fish-piranha', drops: [goldMid, potion] }),
  ...
  M({ id: 'kraken-juvenile', name: 'Kraken juvénile', lore: 'Jeune céphalopode des grands fonds, déjà bardé de tentacules : il patrouille les lagons profonds et enserre quiconque ose nager dans son domaine.', color: 0x2e6f8e, xp: 4200, level: 59, role: 'costaud', speed: 110, behavior: 'charge', aquatic: true, drops: [goldMid, potion, { kind: 'material', materialId: 'gemme-brute', chance: 0.06, min: 1, max: 1 }] }),
  // ═══ Zone 4 — montagne ═══
  M({ id: 'harpie', name: 'Harpie', lore: 'Furie ailée au cri strident, elle fond des cimes en piqué, serres en avant et sans pitié.', color: 0x8d6e63, xp: 2200, level: 47, role: 'rapide', speed: 140, behavior: 'charge', drops: [goldMid, potion, { kind: 'material', materialId: 'croc-de-loup', chance: 0.05, min: 1, max: 1 }] }),
  M({ id: 'yeti', name: 'Yéti', lore: 'Colosse des neiges au grand cœur bourru, paisible tant qu\'on ne trouble pas sa montagne.', color: 0xeceff1, xp: 2600, level: 50, role: 'tank', speed: 45, behavior: 'contact', drops: [goldMid, potion, { kind: 'material', materialId: 'minerai-fer', chance: 0.06, min: 1, max: 1 }, { kind: 'item', itemId: 'plastron-feuilles', chance: 0.04, min: 1, max: 1 }] }),
  M({ id: 'loup-des-neiges', name: 'Loup des neiges', lore: 'Prédateur au pelage givré, silencieux dans la poudreuse : il fond sur sa proie en une charge fulgurante avant qu\'elle n\'entende ses pas.', color: 0xcfe8f5, xp: 2300, level: 48, role: 'rapide', speed: 122, behavior: 'charge', drops: [goldMid, potion, { kind: 'material', materialId: 'croc-de-loup', chance: 0.06, min: 1, max: 1 }] }),
  // ═══ Route alternative — carrière ═══
  M({ id: 'golem-de-pierre', name: 'Golem de pierre', lore: 'Monolithe animé, impassible et lent, il broie tout sur son passage sans jamais s\'énerver.', color: 0x8a8078, xp: 2400, level: 42, role: 'tank', speed: 25, behavior: 'contact', drops: [goldMid, potion, { kind: 'material', materialId: 'minerai-fer', chance: 0.08, min: 1, max: 1 }, { kind: 'item', itemId: 'carapace-scarabee', chance: 0.03, min: 1, max: 1 }] }),
  M({ id: 'gobelin-mineur', name: 'Gobelin mineur', lore: 'Petit fouineur cupide de la carrière, il balance ses cailloux avant de détaler en ricanant.', color: 0x6d8a3f, xp: 2000, level: 39, role: 'distant', speed: 60, behavior: 'projectile', drops: [goldMid, potion, { kind: 'material', materialId: 'minerai-fer', chance: 0.06, min: 1, max: 1 }] }),
  // ═══ Zone 5 — cimetière ═══
  M({ id: 'goule', name: 'Goule', lore: 'Charognarde des tombes, vorace et griffue, elle traque la chair fraîche au fond du cimetière.', color: 0x556b2f, xp: 3200, level: 51, role: 'costaud', speed: 70, behavior: 'contact', drops: [goldMid, potion, { kind: 'material', materialId: 'gemme-brute', chance: 0.05, min: 1, max: 1 }, { kind: 'item', itemId: 'baton-feuillu', chance: 0.03, min: 1, max: 1 }] }),
  M({ id: 'banshee', name: 'Banshee', lore: 'Spectre plaintif au hurlement funeste, son chant déchirant transperce l\'âme à distance.', color: 0x9575cd, xp: 3000, level: 51, role: 'distant', speed: 50, behavior: 'projectile', drops: [goldMid, potion, { kind: 'material', materialId: 'gemme-brute', chance: 0.05, min: 1, max: 1 }] }),
  M({ id: 'pretre-goule', name: 'Prêtre-goule', lore: 'Officiant corrompu des morts, il psalmodie des malédictions et anime les ombres à sa guise.', color: 0x455a64, xp: 3200, level: 51, role: 'distant', speed: 40, behavior: 'caster', drops: [goldMid, potion, { kind: 'material', materialId: 'gemme-brute', chance: 0.06, min: 1, max: 1 }] }),
  M({ id: 'totem-maudit', name: 'Totem maudit', lore: 'Mât funéraire gravé de visages hurlants, scellé au sol : il vomit des feux follets maudits sur qui s\'approche.', color: 0x5a4636, xp: 3100, level: 51, role: 'distant', speed: 0, behavior: 'projectile', drops: [goldMid, potion, { kind: 'material', materialId: 'gemme-brute', chance: 0.06, min: 1, max: 1 }] }),
  ...
  M({ id: 'scarabee-geant', name: 'Scarabée colosse', lore: 'Coléoptère cuirassé devenu titan des sables : sa charge fait trembler les dunes.', color: 0x5b6b3a, xp: 1400, level: 46, role: 'tank', speed: 74, behavior: 'charge', size: 'grand', artFrom: 'scarabee-cornu', drops: [goldMid, potion, { kind: 'material', materialId: 'minerai-fer', chance: 0.08, min: 1, max: 1 }] }),
  ...
  M({ id: 'momie-geante', name: 'Momie géante', lore: 'Colosse embaumé traînant des bandelettes lourdes de siècles, chaque pas ébranle le tombeau.', color: 0xd8cfae, xp: 3000, level: 51, role: 'tank', speed: 26, behavior: 'contact', size: 'grand', artFrom: 'momie', drops: [goldMid, potion, { kind: 'item', itemId: 'plastron-feuilles', chance: 0.06, min: 1, max: 1 }] }),
  M({ id: 'squelette-geant', name: 'Squelette géant', lore: 'Ossature titanesque recollée par la nécromancie : ses phalanges seules pèsent le poids d\'un homme.', color: 0xe8e8e8, xp: 2600, level: 51, role: 'tank', speed: 44, behavior: 'contact', size: 'grand', artFrom: 'squelette', drops: [goldMid, potion, { kind: 'material', materialId: 'gemme-brute', chance: 0.05, min: 1, max: 1 }] }),
  M({ id: 'singe-geant', name: 'Singe géant', lore: 'Primate colossal au poitrail de tambour : il martèle le sol et jette des rochers en hurlant.', color: 0x795548, xp: 2600, level: 50, role: 'costaud', speed: 80, behavior: 'contact', size: 'grand', artFrom: 'singe-grimpeur', drops: [goldMid, potion, { kind: 'material', materialId: 'croc-de-loup', chance: 0.06, min: 1, max: 1 }] }),
  M({ id: 'goule-geante', name: 'Goule géante', lore: 'Charogne enflée jusqu\'à la démesure, griffes comme des faux, elle éventre d\'un seul revers.', color: 0x556b2f, xp: 4800, level: 54, role: 'costaud', speed: 62, behavior: 'contact', size: 'grand', artFrom: 'goule', drops: [goldMid, potion, { kind: 'material', materialId: 'gemme-brute', chance: 0.07, min: 1, max: 1 }] }),
  ...
  {
    id: 'roi-liche', name: 'Roi Liche', lore: 'Seigneur mort-vivant au sceptre glacé, sorcier suprême : il déchaîne des novae nécrotiques et des salves d\'os hurlantes depuis son trône.', color: 0x4527a0, hp: 10500, atk: 176, def: 46, xp: 18000, level: 57, speed: 50, behavior: 'projectile', boss: true, bossClass: 'sorcier', bossSummon: 'squelette',
    drops: [
  ...
  {
    id: 'boss-sylve', name: 'Gardien de la Sylve', lore: 'Colosse de bois millénaire éveillé par la profanation de sa forêt : il abat ses branches comme des massues et invoque les ronces pour étouffer l\'intrus.', color: 0x3e5e2a, hp: 1900, atk: 60, def: 16, xp: 3600, level: 29, speed: 62, behavior: 'charge', boss: true, bossClass: 'novice', bossSummon: 'ronce-cracheuse',
    drops: [
  ...
  {
    id: 'boss-golem-cave', name: 'Golem des Cavernes', lore: 'Titan de roche brute scellé au cœur des cavernes : il pilonne l\'écho de ses poings de granit et fait pleuvoir des éclats du plafond.', color: 0x7c7168, hp: 5200, atk: 132, def: 46, xp: 9200, level: 43, speed: 48, behavior: 'projectile', boss: true, bossClass: 'archer', bossSummon: 'gobelin-mineur', size: 'grand',
    drops: [
      { kind: 'gold', chance: 1, min: 200, max: 320 },
      { kind: 'item', itemId: 'carapace-scarabee', chance: 1, min: 1, max: 1 },
