...
const list: MonsterDef[] = [
  ...
  { id: 'ronce-cracheuse', name: 'Ronce cracheuse', lore: 'Buisson d\'épines enraciné et hargneux : incapable de bouger, il crache des dards acérés sur qui passe à portée.', color: 0x497a3a, hp: 74, atk: 22, def: 6, xp: 640, level: 12, speed: 0, behavior: 'projectile', drops: [goldMid, potion, { kind: 'material', materialId: 'spore-lumineuse', chance: 0.05, min: 1, max: 1 }] },
  ...
  { id: 'fourmi-geante', name: 'Fourmi géante', lore: 'Insecte des dunes vif et increvable, elle détale en tous sens puis fond droit sur l\'intrus, mandibules ouvertes.', color: 0x8a4b2a, hp: 106, atk: 90, def: 12, xp: 760, level: 16, speed: 135, behavior: 'charge', drops: [goldMid, potion, { kind: 'material', materialId: 'dard-de-scorpion', chance: 0.05, min: 1, max: 1 }] },
  // MOBILE-MÊLÉE (charge cornue) — désert/carrière. Charge tête baissée, corne en avant.
  { id: 'scarabee-cornu', name: 'Scarabée cornu', lore: 'Coléoptère cuirassé au front armé d\'une corne : il baisse la tête et charge tout ce qui bouge.', color: 0x5b6b3a, hp: 132, atk: 96, def: 22, xp: 900, level: 16, speed: 92, behavior: 'charge', drops: [goldMid, potion, { kind: 'material', materialId: 'minerai-fer', chance: 0.06, min: 1, max: 1 }] },
  ...
  {
    id: 'mini-baphomet', name: 'Mini Baphomet', lore: 'Diablotin cornu au sourire mauvais, minuscule mais déjà rongé par la malice infernale.', color: 0x6a1b4d, hp: 240, atk: 125, def: 24, xp: 1500, level: 25, speed: 80, behavior: 'charge',
  ...
  { id: 'chauve-souris', name: 'Chauve-souris', lore: 'Bestiole nerveuse et imprévisible, elle zigzague dans l\'ombre et pique dès qu\'on baisse la garde.', color: 0x6b4f9e, hp: 70, atk: 106, def: 8, xp: 600, level: 24, speed: 120, behavior: 'charge', drops: [goldMid, potion] },
  { id: 'fantome', name: 'Fantôme', lore: 'Âme errante et mélancolique qui hante les cavernes et souffle des projectiles glacés.', color: 0xb2ebf2, hp: 80, atk: 75, def: 22, xp: 700, level: 24, speed: 35, behavior: 'projectile', drops: [goldMid, potion, { kind: 'material', materialId: 'gemme-brute', chance: 0.04, min: 1, max: 1 }] },
  { id: 'mage-noir', name: 'Mage noir', lore: 'Sorcier félon tapi dans l\'obscurité, il tisse ses maléfices à distance, sournois et calculateur.', color: 0x7e57c2, hp: 100, atk: 88, def: 12, xp: 850, level: 24, speed: 45, behavior: 'caster', drops: [goldMid, potion, { kind: 'material', materialId: 'gemme-brute', chance: 0.05, min: 1, max: 1 }] },
  ...
  { id: 'ours-brun', name: 'Ours brun', lore: 'Masse de muscles et de fourrure : lent mais redoutable, il se dresse de toute sa hauteur avant d\'abattre ses pattes.', color: 0x6d4325, hp: 470, atk: 132, def: 35, xp: 1620, level: 29, speed: 55, behavior: 'contact', size: 'grand', drops: [goldMid, potion, { kind: 'material', materialId: 'croc-de-loup', chance: 0.08, min: 1, max: 1 }] },
  // Route alternative — plage
  { id: 'crabe-geant', name: 'Crabe géant', lore: 'Sentinelle bardée de carapace sur la plage, lente mais coriace, elle ne cède pas un pouce de sable.', color: 0xe64a19, hp: 230, atk: 112, def: 30, xp: 1400, level: 31, speed: 40, behavior: 'contact', drops: [goldMid, potion, { kind: 'material', materialId: 'gemme-brute', chance: 0.05, min: 1, max: 1 }] },
  { id: 'meduse', name: 'Méduse', lore: 'Beauté translucide et trompeuse, elle dérive au gré des flots et décharge ses filaments urticants.', color: 0xba68c8, hp: 150, atk: 125, def: 10, xp: 1350, level: 31, speed: 25, behavior: 'projectile', drops: [goldMid, potion, { kind: 'material', materialId: 'gemme-brute', chance: 0.05, min: 1, max: 1 }] },
  // Zone 4 — montagne
  { id: 'harpie', name: 'Harpie', lore: 'Furie ailée au cri strident, elle fond des cimes en piqué, serres en avant et sans pitié.', color: 0x8d6e63, hp: 260, atk: 162, def: 20, xp: 2200, level: 34, speed: 140, behavior: 'charge', drops: [goldMid, potion, { kind: 'material', materialId: 'croc-de-loup', chance: 0.05, min: 1, max: 1 }] },
  { id: 'yeti', name: 'Yéti', lore: 'Colosse des neiges au grand cœur bourru, paisible tant qu\'on ne trouble pas sa montagne.', color: 0xeceff1, hp: 380, atk: 175, def: 35, xp: 2600, level: 37, speed: 45, behavior: 'contact', drops: [goldMid, potion, { kind: 'material', materialId: 'minerai-fer', chance: 0.06, min: 1, max: 1 }, { kind: 'item', itemId: 'plastron-feuilles', chance: 0.04, min: 1, max: 1 }] },
  // Route alternative — carrière
  { id: 'golem-de-pierre', name: 'Golem de pierre', lore: 'Monolithe animé, impassible et lent, il broie tout sur son passage sans jamais s\'énerver.', color: 0x8a8078, hp: 340, atk: 150, def: 40, xp: 2400, level: 27, speed: 25, behavior: 'contact', drops: [goldMid, potion, { kind: 'material', materialId: 'minerai-fer', chance: 0.08, min: 1, max: 1 }, { kind: 'item', itemId: 'carapace-scarabee', chance: 0.03, min: 1, max: 1 }] },
  { id: 'gobelin-mineur', name: 'Gobelin mineur', lore: 'Petit fouineur cupide de la carrière, il balance ses cailloux avant de détaler en ricanant.', color: 0x6d8a3f, hp: 220, atk: 138, def: 18, xp: 2000, level: 24, speed: 60, behavior: 'projectile', drops: [goldMid, potion, { kind: 'material', materialId: 'minerai-fer', chance: 0.06, min: 1, max: 1 }] },
  // Zone 5 — cimetière
  ...
  { id: 'totem-maudit', name: 'Totem maudit', lore: 'Mât funéraire gravé de visages hurlants, scellé au sol : il vomit des feux follets maudits sur qui s\'approche.', color: 0x5a4636, hp: 340, atk: 205, def: 26, xp: 3100, level: 41, speed: 0, behavior: 'projectile', drops: [goldMid, potion, { kind: 'material', materialId: 'gemme-brute', chance: 0.06, min: 1, max: 1 }] },
  // Zone 6 — enfer
  { id: 'diablotin', name: 'Diablotin', lore: 'Farceur des flammes, vif et hargneux, il fonce en ricanant droit sorti des enfers.', color: 0xd84315, hp: 480, atk: 238, def: 35, xp: 4200, level: 48, speed: 150, behavior: 'charge', drops: [goldMid, potion, { kind: 'material', materialId: 'gemme-brute', chance: 0.06, min: 1, max: 1 }] },
  ...
  { id: 'gardien-pierre', name: 'Gardien Pierre', lore: 'Sentinelle de roc dressée depuis l\'aube des temps, inébranlable, elle veille sans jamais ciller.', color: 0x707070, hp: 3200, atk: 80, def: 55, xp: 3200, level: 50, speed: 0, behavior: 'contact', drops: [goldMid, potion, { kind: 'material', materialId: 'minerai-fer', chance: 0.2, min: 1, max: 2 }] },
