...
const list: MonsterDef[] = [
  ...
  { id: 'gardien-pierre', name: 'Gardien Pierre', lore: 'Sentinelle de roc dressée depuis l\'aube des temps, inébranlable, elle veille sans jamais ciller.', color: 0x707070, hp: 3200, atk: 80, def: 55, xp: 3200, level: 31, speed: 0, behavior: 'contact', drops: [goldMid, potion, { kind: 'material', materialId: 'minerai-fer', chance: 0.2, min: 1, max: 2 }] },
  ...
  {
    id: 'seigneur-dechu', name: 'Seigneur Déchu', lore: 'Maître ultime des enfers, ange tombé rongé de haine : l\'affronter, c\'est défier l\'apocalypse elle-même.', color: 0x8a1414, hp: 14000, atk: 190, def: 55, xp: 30000, level: 54, speed: 70, behavior: 'charge', boss: true,
    drops: [
