...
export const CLASSES: Record<ClassId, ClassDef> = {
  ...
  swordsman: {
    ...
    skillIds: ['estoc-rapide', 'taillade', 'tourbillon', 'lancer-epee', 'attaque-chargee', 'plongeon', 'folie-enragee', 'double-saut', 'regeneration'],
  },
  mage: {
    ...
    skillIds: ['boule-de-feu', 'eclair', 'mur-de-flamme', 'nova-de-givre', 'soin-du-panda', 'aura-epines', 'maitrise-arcanique', 'vitalite-magique', 'vol-arcanique'],
  },
  archer: {
    ...
    skillIds: ['fleche-percante', 'tir-instinctif', 'double-tir', 'fleche-autoguidee', 'pluie-de-fleches', 'piege', 'fleche-grappin', 'oeil-de-lynx', 'reflexes-felins'],
  },
  chevalier: {
    ...
    skillIds: ['garde-imperiale', 'charge-lanciere', 'sceau-du-heaume', 'grand-croix', 'epee-fantome', 'devotion', 'frappe-doublee'],
  },
  sorcier: {
    ...
    skillIds: ['faille-du-neant', 'lance-flammes', 'pluie-de-meteores', 'tempete-foudroyante', 'blizzard', 'rayon-arcanique', 'benediction-du-panda'],
  },
  chasseur: {
    ...
    skillIds: ['mitraillette', 'tir-du-faucon', 'blitz-faucon', 'nuee-de-fleches', 'fleche-mortelle', 'fleche-enflammee', 'fleche-explosive'],
  },
}
