...
const list: ItemDef[] = [
  ...
  { id: 'sabre-acier', name: 'Sabre en acier', slot: 'weapon', bonus: { atk: 9 }, rarity: 'rare' },
  { id: 'arc-composite', name: 'Arc composite', slot: 'weapon', bonus: { atk: 10 }, rarity: 'rare' },
  { id: 'baton-cristal', name: 'Bâton de cristal', slot: 'weapon', bonus: { atk: 11, maxHp: 10 }, rarity: 'rare' },
