...
const list: SkillDef[] = [
  ...
  { id: 'eclair', name: 'Éclairs foudroyants', description: 'De gros éclairs bleus zigzaguent devant le mage : courte portée, mais dégâts frontaux dévastateurs.', classId: 'mage', kind: 'lightning', multiplier: 3.2, cooldownMs: 6500, range: 250, minLevel: 10, requires: 'boule-de-feu' },
  ...
  { id: 'fleche-enflammee', name: 'Flèche enflammée', description: 'Une flèche embrasée qui perce la ligne ennemie et laisse chaque cible brûler dans la durée.', classId: 'archer', kind: 'projectile', multiplier: 2.2, cooldownMs: 6000, range: 660, pierce: true, burn: true, minLevel: 10, requires: 'fleche-percante' },
  ...
  { id: 'reflexes-felins', name: 'Réflexes félins', description: 'Passif : l\'entraînement aiguise les réflexes de l\'archer et accélère durablement sa cadence de tir. Jamais équipé — actif dès qu\'il est appris. +0,08 att./s par rang.', classId: 'archer', kind: 'passive', multiplier: 1, cooldownMs: 1, range: 0, passive: { attackSpeed: 0.08 }, minLevel: 6 },
