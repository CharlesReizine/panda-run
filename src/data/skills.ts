...
const list: SkillDef[] = [
  ...
  { id: 'fleche-explosive', name: 'Grenade', description: 'Une grenade lancée en cloche : elle retombe et détone au sol dans une gerbe de feu.', classId: 'archer', kind: 'projectile', multiplier: 2.4, cooldownMs: 7000, range: 560, arc: true, explode: true, explodeRadius: 120, minLevel: 31 },
