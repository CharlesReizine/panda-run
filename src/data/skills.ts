...
const list: SkillDef[] = [
  ...
  // FLÈCHE-GRAPPIN (déplacement) : tire un grappin, s\'accroche à une plateforme/rebord devant ou
  // au-dessus et TRACTE le panda dessus (proche du homing mais cible le DÉCOR ; petit bond si rien).
  { id: 'fleche-grappin', name: 'Flèche-grappin', description: 'Tire un grappin qui s\'accroche à une plateforme devant ou au-dessus et TRACTE le panda dessus. Sans prise, un petit bond de secours.', classId: 'archer', kind: 'projectile', multiplier: 0.8, cooldownMs: 6000, range: 520, grapple: true, minLevel: 8 },
  ...
  { id: 'charge-lanciere', name: 'Charge lancière', description: 'Le chevalier abaisse sa lance et embroche toute la ligne ennemie devant lui d\'un trait perçant fulgurant.', classId: 'chevalier', kind: 'projectile', multiplier: 3.0, cooldownMs: 6000, range: 620, pierce: true, lance: true, minLevel: 30 },
