...
const list: LevelDef[] = [
  { id: 'zone1-1', name: 'Prairie de Prontera', biome: 'plaine', widthTiles: 90,
    ...
    props: [prop('herbe', 10), prop('champignon', 38), prop('herbe', 68), prop('coffre', 22, 10)] },
  { id: 'zone1-2', name: 'Champs fleuris', biome: 'plaine', widthTiles: 100,
    ...
    props: [prop('herbe', 12), prop('champignon', 45), prop('herbe', 78), prop('coffre', 57, 10)] },
  { id: 'zone1-3', name: 'Orée de la forêt', biome: 'foret', widthTiles: 100,
    ...
    props: [prop('herbe', 8), prop('champignon', 48), prop('herbe', 95), prop('coffre', 37, 7)] },
  { id: 'zone1-4', name: 'Forêt profonde', biome: 'foret', widthTiles: 110,
    ...
    props: [prop('herbe', 10), prop('champignon', 30), prop('herbe', 65), prop('champignon', 105), prop('coffre', 47, 10)] },
  ...
  { id: 'zone2-1', name: 'Dunes de Sograt', biome: 'desert', widthTiles: 100,
    ...
    props: [prop('roche', 12), prop('herbe', 48), prop('roche', 90), prop('coffre', 32, 9)] },
  { id: 'zone2-2', name: 'Oasis perdue', biome: 'desert', widthTiles: 110,
    ...
    props: [prop('roche', 10), prop('herbe', 35), prop('roche', 70), prop('herbe', 105), prop('coffre', 52, 10)] },
  { id: 'zone2-3', name: 'Vallée des tombeaux', biome: 'desert', widthTiles: 110,
    ...
    props: [prop('roche', 12), prop('herbe', 38), prop('roche', 105), prop('coffre', 47, 7)] },
  { id: 'cave-1', name: 'Cave aux échos', biome: 'cave', widthTiles: 105,
    ...
    props: [prop('roche', 10), prop('champignon', 32), prop('roche', 52), prop('champignon', 90), prop('coffre', 47, 10)] },
