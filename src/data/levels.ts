...
const list: LevelDef[] = [
  { id: 'zone1-1', name: 'Prairie de Prontera', biome: 'plaine', widthTiles: 90,
    // plat(50, 7, 4) : palier de sommet de l'échelle x=54, posé 2 rangées sous le haut du montant
    // pour que les pieds du panda (centre + ~1,25 tuile) atteignent sa surface en grimpant, puis
    // qu'il y marche à gauche
    platforms: [plat(22, 11, 5), plat(26, 8, 4), plat(55, 11, 4), plat(50, 7, 4)],
  ...
  { id: 'zone1-3', name: 'Orée de la forêt', biome: 'foret', widthTiles: 100,
    // plat(55, 7, 4) : palier de sommet de l'échelle x=59, 2 rangées sous le haut (pieds atteignables)
    platforms: [plat(20, 11, 4), plat(24, 8, 4), plat(28, 5, 4), plat(60, 10, 4), plat(55, 7, 4)],
  ...
  { id: 'zone2-2', name: 'Oasis perdue', biome: 'desert', widthTiles: 110,
    // plat(73, 7, 4) : palier de sommet de l'échelle x=77, 2 rangées sous le haut (pieds atteignables)
    platforms: [plat(22, 11, 4), plat(26, 8, 4), plat(30, 5, 4), plat(78, 11, 4), plat(82, 8, 4), plat(73, 7, 4)],
  ...
  { id: 'cave-1', name: 'Cave aux échos', biome: 'cave', widthTiles: 105,
    // plat(53, 7, 4) : palier de sommet de l'échelle x=57, 2 rangées sous le haut (pieds atteignables)
    platforms: [plat(18, 11, 4), plat(22, 8, 4), plat(26, 5, 4), plat(58, 11, 4), plat(62, 8, 4), plat(53, 7, 4)],
  ...
  { id: 'zone3-1', name: 'Lisière de la jungle', biome: 'jungle', widthTiles: 130,
    // plat(75, 7, 4) : palier de sommet de l'échelle x=79, 2 rangées sous le haut (pieds atteignables)
    platforms: [plat(15, 11, 5), plat(20, 8, 4), plat(24, 5, 4), plat(45, 12, 6), plat(56, 11, 4), plat(60, 9, 4), plat(66, 6, 4), plat(80, 10, 5), plat(95, 13, 6), plat(105, 11, 4), plat(110, 10, 4), plat(115, 7, 4), plat(75, 7, 4)],
  ...
  { id: 'zone4-1', name: 'Sentier des cimes', biome: 'montagne', widthTiles: 135,
    // plat(90, 7, 4) : palier de sommet de l'échelle x=94, 2 rangées sous le haut (pieds atteignables)
    platforms: [plat(16, 11, 4), plat(20, 8, 4), plat(24, 5, 4), plat(45, 12, 6), plat(65, 13, 4), plat(69, 10, 4), plat(73, 7, 4), plat(95, 11, 5), plat(110, 13, 4), plat(118, 10, 4), plat(122, 7, 4), plat(90, 7, 4)],
