...
const list: LevelDef[] = [
  ...
  { id: 'zone1-3', name: 'Orée de la forêt', biome: 'foret', widthTiles: 100,
    platforms: [plat(15, 10, 4), plat(35, 9, 5), plat(60, 10, 6)],
    ...
    props: [prop('herbe', 8), prop('champignon', 48), prop('herbe', 95), prop('coffre', 37, 8), prop('coffre', 62, 9)] },
  ...
  { id: 'zone2-3', name: 'Vallée des tombeaux', biome: 'desert', widthTiles: 110,
    platforms: [plat(20, 10, 4), plat(45, 9, 5), plat(75, 10, 5)],
    spawns: [{ monsterId: 'momie', x: 25 }, { monsterId: 'vautour', x: 45 }, { monsterId: 'momie', x: 60 }, { monsterId: 'vautour', x: 80 }, { monsterId: 'momie', x: 95 }],
    props: [prop('roche', 12), prop('herbe', 38), prop('roche', 105), prop('coffre', 47, 8), prop('coffre', 77, 9)] },
