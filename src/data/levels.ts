...
const list: LevelDef[] = [
  ...
  { id: 'plage-1', name: 'Rivage de corail', biome: 'plage', widthTiles: 110, heightTiles: 42,
    ...
    spawns: [{ monsterId: 'crabe-geant', x: 12 }, { monsterId: 'meduse', x: 24 }, { monsterId: 'roi-crabe', x: 36 }, { monsterId: 'crabe-geant', x: 46 }, { monsterId: 'meduse', x: 70 }, { monsterId: 'crabe-geant', x: 78 }, { monsterId: 'meduse', x: 90 }, { monsterId: 'crabe-geant', x: 100 }, { monsterId: 'meduse', x: 104 }, { monsterId: 'ara', x: 30, y: 30 }, { monsterId: 'ara', x: 88, y: 28 }],
  ...
  { id: 'zone5-1', name: 'Nécropole oubliée', biome: 'cimetiere', widthTiles: 210, heightTiles: 46,
    ...
    spawns: [{ monsterId: 'goule', x: 10 }, { monsterId: 'banshee', x: 28 }, { monsterId: 'goule', x: 42 }, { monsterId: 'pretre-goule', x: 50 }, { monsterId: 'banshee', x: 58 }, { monsterId: 'goule', x: 72 }, { monsterId: 'spectre-ancien', x: 78 }, { monsterId: 'banshee', x: 88 }, { monsterId: 'goule', x: 102 }, { monsterId: 'banshee', x: 118 }, { monsterId: 'goule', x: 132 }, { monsterId: 'spectre-ancien', x: 146 }, { monsterId: 'banshee', x: 160 }, { monsterId: 'goule', x: 174 }, { monsterId: 'pretre-goule', x: 188 }, { monsterId: 'banshee', x: 200 }, { monsterId: 'harfang-spectral', x: 60, y: 36 }, { monsterId: 'harfang-spectral', x: 168, y: 34 }],
