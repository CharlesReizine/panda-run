...
const list: LevelDef[] = [
  { id: 'zone1-1', name: 'Prairie de Prontera', biome: 'plaine', widthTiles: 90,
    ...
    spawns: [{ monsterId: 'gloopy', x: 12 }, { monsterId: 'gloopy', x: 38 }, { monsterId: 'gloopy', x: 50 }, { monsterId: 'mandragore', x: 62 }, { monsterId: 'gloopy', x: 75 }],
  ...
  { id: 'zone1-2', name: 'Champs fleuris', biome: 'plaine', widthTiles: 100,
    ...
    spawns: [{ monsterId: 'gloopy', x: 18 }, { monsterId: 'mandragore', x: 48 }, { monsterId: 'gloopy', x: 58 }, { monsterId: 'mandragore', x: 65 }, { monsterId: 'louveteau', x: 85 }],
  ...
  { id: 'zone1-3', name: 'Orée de la forêt', biome: 'foret', widthTiles: 100,
    ...
    spawns: [{ monsterId: 'louveteau', x: 14 }, { monsterId: 'mandragore', x: 44 }, { monsterId: 'louveteau', x: 55 }, { monsterId: 'mandragore', x: 70 }, { monsterId: 'louveteau', x: 85 }],
  ...
  { id: 'zone1-4', name: 'Forêt profonde', biome: 'foret', widthTiles: 110,
    ...
    spawns: [{ monsterId: 'louveteau', x: 14 }, { monsterId: 'louveteau', x: 44 }, { monsterId: 'mandragore', x: 55 }, { monsterId: 'louveteau', x: 62 }, { monsterId: 'louveteau', x: 90 }, { monsterId: 'mandragore', x: 100 }],
  ...
  { id: 'zone2-1', name: 'Dunes de Sograt', biome: 'desert', widthTiles: 100,
    ...
    spawns: [{ monsterId: 'scorpion', x: 18 }, { monsterId: 'scorpion', x: 52 }, { monsterId: 'vautour', x: 62 }, { monsterId: 'scorpion', x: 82 }],
  ...
  { id: 'zone2-3', name: 'Vallée des tombeaux', biome: 'desert', widthTiles: 110,
    ...
    spawns: [{ monsterId: 'momie', x: 14 }, { monsterId: 'vautour', x: 48 }, { monsterId: 'momie', x: 60 }, { monsterId: 'vautour', x: 82 }, { monsterId: 'momie', x: 95 }],
  ...
  { id: 'cave-1', name: 'Cave aux échos', biome: 'cave', widthTiles: 105,
    ...
    spawns: [{ monsterId: 'chauve-souris', x: 14 }, { monsterId: 'squelette', x: 44 }, { monsterId: 'chauve-souris', x: 60 }, { monsterId: 'squelette', x: 82 }, { monsterId: 'chauve-souris', x: 95 }],
